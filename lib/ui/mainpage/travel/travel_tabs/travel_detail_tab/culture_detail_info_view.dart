    ...
    return Column(
      ...
      children: [
        ...
        if (cultureData.cultureInfoTel != null)
          travelInfoRow(context, '문의 및 안내', cultureData.cultureInfoTel!),
        if (cultureData.cultureUseTime != null)
          travelInfoRow(context, '이용시간', cultureData.cultureUseTime!),
        if (cultureData.cultureRestDate != null)
          travelInfoRow(context, '휴일', cultureData.cultureRestDate!),
        if (cultureData.cultureParking != null)
          travelInfoRow(context, '주차 시설', cultureData.cultureParking!),
        if (cultureData.cultureUseFee != null)
          travelInfoRow(context, '이용 요금', cultureData.cultureUseFee!),
        if (cultureData.cultureScale != null)
          travelInfoRow(context, '규모', cultureData.cultureScale!),
